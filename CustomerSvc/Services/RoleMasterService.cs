...
namespace GRCServices.Services
{
    public class RoleMasterService : IRoleMaster
    {
        ...
        public async Task<ServiceResponse<List<GetRoleMasterDto>>> AddRole(AddRoleMasterDto newRoleMasterdto)
        {
            ...
            string connectionString = _context.SysCustomerInfos.Where(c => c.Id == newRoleMasterdto.CustomerId).Select(c => c.DbMapString).FirstOrDefault();
        ...
        public async Task<ServiceResponse<List<GetRoleMasterDto>>> UpdateRole(UpdateRoleMasterDto updatedRole,int Roleid)
        {
            ...
            string connectionString = _context.SysCustomerInfos.Where(c => c.Id == updatedRole.CustomerId).Select(c => c.DbMapString).FirstOrDefault();
        ...
        public async Task<ServiceResponse<List<GetRoleMasterDto>>> DeleteRole(int id)
        {
            ServiceResponse<List<GetRoleMasterDto>> svcResponse = new ServiceResponse<List<GetRoleMasterDto>>();
            try
            {
                ClientRoleMaster? tobedeletedcf = _context.ClientRoleMasters
                ...
                if (tobedeletedcf != null)
                {
                    ...
                    _context.ClientRoleMasters.Remove(tobedeletedcf);
